...
class Histogram2D(Benchmark):
    ...
    def time_slow_full_coverage(self):
        np.histogramdd(self.d, self.edges_full)

    def time_slow_small_coverage(self):
        np.histogramdd(self.d, self.edges_small)

    def time_slow_fine_binning(self):
